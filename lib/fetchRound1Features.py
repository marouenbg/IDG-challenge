...
#read drugcommons db
os.chdir("../data/Round1")
df=pd.read_csv("round_1_template.csv")
print(df.shape)
...
print(missingProts)
np.save('Round1_protStructure.npy', seq_dict)
